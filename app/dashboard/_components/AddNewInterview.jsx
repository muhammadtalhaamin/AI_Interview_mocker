...
function AddNewInterview() {
  ...
  const onSubmit=async(e)=>{
    ...
    const MockJasonResp= (result.response.text()).replace('```json','').replace('```', '');
    ...
    .values({
      mockId:uuidv4(),
      jsonMockResponse:MockJasonResp, 
    ...
    <div>
      ...
      <Dialog open={openDialog}>
        ...
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle className='text-2xl'>Let's dicuss about the Job you're going to be interviewed</DialogTitle>
            <DialogDescription>
              ...
              <div className='mt-7 my-3'>
                 ...
                 <Textarea placeholder="Ex. MERN stack developer" required
